...
LangString appRunning ${LANG_ENGLISH} "{{product_name}} is still running. Close it and try again."
LangString appRunningOkKill ${LANG_ENGLISH} "{{product_name}} is running.$\n$\nClick OK to close it (including background processes) and continue."
...
LangString failedToKillApp ${LANG_ENGLISH} "Could not close {{product_name}} (a background process may still be locking files). Quit it manually, then click Retry."
LangString installingWebview2 ${LANG_ENGLISH} "Installing WebView2..."
LangString newerVersionInstalled ${LANG_ENGLISH} "A newer version of ${PRODUCTNAME} is already installed. Installing an older version is not recommended; if you continue, you can update without uninstalling. Select an option and click Next to continue."
LangString older ${LANG_ENGLISH} "older"
LangString olderOrUnknownVersionInstalled ${LANG_ENGLISH} "An $R4 version of ${PRODUCTNAME} is installed on your system. You can update without uninstalling first. Select an option and click Next to continue."
